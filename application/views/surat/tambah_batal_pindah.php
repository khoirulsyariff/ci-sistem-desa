            ...
            <div class="box-header">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <h4 style="text-align:center"><b>TAMBAH SURAT KETERANGAN BATAL PINDAH</b></h4>
                                <hr>
                            </div>
                ...
                ?>
                                ...
                                <form action="<?php echo base_url('surat/batal_pindah/tambah'); ?>" method="post">
                        ...
                        ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="alamat" class="form-control"
                                                placeholder="Alamat Batal Pindah" required />
                                        </div>
                                        <div class="form-group">
                        ...
                        ?>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="tambah_batal_pindah" class="btn btn-success"
                                                value="Simpan">
                                            <a href="<?php echo base_url('surat/batal_pindah/'); ?>"
