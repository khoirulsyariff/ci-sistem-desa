<div class="content-wrapper">
    <section class="content">
        ...
        ?>
                <p>
                    <a href="<?php echo base_url('surat/menikah/tambah'); ?>" class="btn btn-success">Tambah Surat
                        MENIKAH</a>
                </p>
              ...
              ?>
                        <tr>
                            ...
                            <td style="text-align:center">
                                ...
                                <a href="<?php echo base_url('surat/menikah/hapus/' . $surat->id_menikah); ?>"
                                    class="btn btn-danger btn-xs"
                                    onClick="return confirm('Yakin Akan Menghapus Data?');"><i
                                        class="fa fa-trash-o"></i> Hapus</a>
                                <a target="blank"
                                    href="<?php echo base_url('surat/menikah/cetak/' . $surat->id_menikah); ?>"
