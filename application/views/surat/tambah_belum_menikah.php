id="nama" <div class="content-wrapper">
      ...
      <div class="box-header">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                <h4 style="text-align:center"><b>TAMBAH SURAT BELUM MENIKAH</b></h4><hr>
              </div>
...
?>
              ...
              <form action="<?php echo base_url('surat/belum_menikah/tambah'); ?>" method="post">
