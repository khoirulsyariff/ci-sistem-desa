      ...
      <div class="box-header">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                <h4 style="text-align:center"><b>EDIT SURAT PENGANTAR BATAL PINDAH</b></h4><hr>
              </div>
...
?>
              ...
              <form action="<?php echo base_url('surat/batal_pindah/edit'); ?>" method="post">

                <div class="card-body">
                  <div class="form-group">
                    <label>NIK</label>
                      <input type="hidden" name="id" class="form-control" required  value="<?php echo $batal_pindah->id_batal_pindah; ?>"/>
					  <select name="nik" class="form-control" id="nama"  required>
						<?php
foreach ($penduduk as $penduduk):
	if ($penduduk->nik == $batal_pindah->nik) {
		?>
...
foreach ($pejabat as $pejabat):
	if ($pejabat->id_pejabat == $batal_pindah->id_pejabat) {
		?>
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <a href="<?php echo base_url('surat/batal_pindah/'); ?>" class="btn btn-danger">Batal</a>
                  </div>
                </div>
              </form>
            </div>
