      ...
      <div class="box-header">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              <div class="card">
                <h4 style="text-align:center"><b>EDIT SURAT KETERANGAN DAFTAR HAJI</b></h4><hr>
              </div>
...
?>
              ...
              <form action="<?php echo base_url('surat/haji/edit'); ?>" method="post">

                <div class="card-body">
                  <div class="form-group">
                    <label>NIK</label>
                      <input type="hidden" name="id" class="form-control" required  value="<?php echo $haji->id_haji; ?>"/>
					  <select name="nik" class="form-control" id="nama" required>
						<?php
foreach ($penduduk as $penduduk):
	if ($penduduk->nik == $haji->nik) {
		?>
...
foreach ($pejabat as $pejabat):
	if ($pejabat->id_pejabat == $haji->id_pejabat) {
		?>
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <a href="<?php echo base_url('surat/haji/'); ?>" class="btn btn-danger">Batal</a>
                  </div>
                </div>
              </form>
            </div>
