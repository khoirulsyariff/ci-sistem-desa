<div class="content-wrapper">
    <section class="content">
        ...
        ?>
                <p>
                    <a href="<?php echo base_url('surat/usaha/tambah'); ?>" class="btn btn-success">Tambah Surat
                        Keterangan Usaha</a>
                </p>
              ...
              ?>
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="<?php echo base_url('surat/usaha/edit/' . $surat->id_usaha); ?>"
                                    class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                <a href="<?php echo base_url('surat/usaha/hapus/' . $surat->id_usaha); ?>"
                                    class="btn btn-danger btn-xs"
                                    onClick="return confirm('Yakin Akan Menghapus Data?');"><i
                                        class="fa fa-trash-o"></i> Hapus</a>
                                <a target="blank"
                                    href="<?php echo base_url('surat/usaha/cetak/' . $surat->id_usaha); ?>"
