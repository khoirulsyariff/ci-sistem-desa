            ...
            <div class="box-header">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <h4 style="text-align:center"><b>TAMBAH SURAT IZIN KELUARGA</b></h4>
                                <hr>
                            </div>
                ...
                ?>
                                ...
                                <form action="<?php echo base_url('surat/izin_keluarga/tambah'); ?>" method="post">
                        ...
                        ?>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="tambah_izin_keluarga" class="btn btn-success"
                                                value="Simpan">
